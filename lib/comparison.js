...
/**
 * Returns true if the given `value` is falsey: if the value is false,
 * null, undefined, NaN, 0, 0n (BigInt), or an empty string.
 *
 * @param {any} `val`
...
helpers.isFalsey = function(val, options) {
  return util.value(isFalsey(val), this, options);
};
