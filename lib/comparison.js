 ...
 * ```handlebars
 * <!-- isItFriday: true -->
 * {{ternary isItFriday "Yes" "No"}}
 * <!-- results in: "Yes" -->
 * ```
 *
 * @param {any} `condition` An expression whose value is used as a condition
 * @param {any} `exprT` Expression with value of any type
 * @param {any} `exprF` Expression with value of any type
 * @return {any}
 * @api public
 */

helpers.ternary = function(condition, exprT, exprF) {
  return condition ? exprT : exprF;
};
