 ...
 * @param {Options} `options` Handlebars provided options object
 * @return {Object} Returns a parsed object
 * @api public
 */

helpers.urlParse = function(str, options) {
  return url.parse(str, options.hash.parseQueryString);
};
...
helpers.parseQueryString = function(str) {
