...
var helpers = {
  ...
  /**
   * {{splitCamelCase}}
   * @author: Stefan Rauchegger <http://github.com/smadep>
   * split camel-cased string at capital letters with spaces
   * not considering first letter of input string
   
   * @param  {String} str      The input string.
   * @return {String}          The split string.
   * @example:
   *   {{splitCamelCase "BusinessObjectConfirmed"}} --> "Business Object Confirmed"
   *   {{splitCamelCase "objectConfirmed"}} --> "object Confirmed"
   */
