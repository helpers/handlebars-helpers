...
(function() {
  var Handlebars, Utils, after, any, arrayify, before, eachIndex, eachProperty, eachWithClasses, empty, first, forEach, inArray, iterate, join, joinAny, last, length, lengthEqual, sort, withAfter, withBefore, withFirst, withLast, withSort, _;
  ...
  module.exports.each_with_classes = eachWithClasses = function(array, fn) {
    var buffer, i, item, j;
