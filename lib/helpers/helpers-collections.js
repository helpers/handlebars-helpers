...
(function() {
  var Handlebars, Utils, after, any, arrayify, before, eachIndex, eachIndexPlusOne, eachProperty, empty, first, forEach, inArray, iterate, join, joinAny, last, length, lengthEqual, sort, withAfter, withBefore, withFirst, withLast, withSort, _,
  ...
  module.exports = {
    ...
    */
    ...
    eachProperty: eachProperty = function(context, options) {
