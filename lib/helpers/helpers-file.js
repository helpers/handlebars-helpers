(function() {
  var Handlebars, Utils, chapter, copy, defineSection, dir, dirJSON, expMappingJSON, expMappingYAML, extract, glob, grunt, include, listHelpers, path, renderSection, to, toc, _;
  ...
  */
  ...
  module.exports.listHelpers = listHelpers = function(src) {
    var content;
