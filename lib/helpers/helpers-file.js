(function() {
  var Handlebars, Utils, chapter, copy, defineSection, dir, dirJSON, expMappingJSON, expMappingYAML, extract, glob, grunt, include, less, path, renderSection, to, toc, _;
  ...
  */
  ...
  module.exports.toc = toc = function(src) {
    ...
    return Utils.safeString(headings);
  };
