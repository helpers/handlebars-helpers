    ...
    thumbnailImage: function (context) {
      ...
      if (context.classes) {
        ...
        if (context.classes.figure) {
          figureAttributes.class = 'js-thumbnail ' + context.classes.figure.join(' ');
        }
      ...
      figure += '<figure ' + Utils.pairedAttributes(figureAttributes).join(' ') + '>\n';

      image = '<img ' + Utils.pairedAttributes(imageAttributes).join(' ') + '>\n';

      if (link) {
        figure += '<a ' + Utils.pairedAttributes(linkAttributes).join(' ') + '>\n' + image + '</a>\n';
      } else {
        figure += image;
      }
