...
helpers.isArray = function isArray(val) {
...
helpers.arrayify = function arrayify(val){
...
helpers.first = function first(arr, n) {
...
helpers.last = function last(arr, n) {
  if (!arr || arr.length === 0) return '';
  if (!isNumber(n)) {
...
helpers.before = function before(arr, n) {
  if (!arr || arr.length === 0) return '';
  return arr.slice(0, -n);
};
...
helpers.after = function after(arr, n) {
  if (!arr || arr.length === 0) return '';
  return arr.slice(n);
};
...
helpers.map = function map(arr, fn) {
...
helpers.join = function join(arr, sep) {
  if (!arr || arr.length === 0) return '';
...
helpers.sort = function sort(arr, key) {
  if (!arr || arr.length === 0) return '';
...
helpers.length = function length(arr) {
...
helpers.compact = function compact(arr) {
  if (!arr || !arr.length) return '';
...
helpers.difference = function difference(a, b, c) {
...
helpers.unique = function unique(arr) {
...
helpers.union = function union(arr) {
  if (!arr || arr.length === 0) return '';
...
helpers.shuffle = function shuffle(arr) {
  var len = arr.length;
  var res = Array(len);
  var i = -1;
