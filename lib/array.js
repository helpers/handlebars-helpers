...
helpers.lengthGt = function(array, length, options) {
  if (array.length > length) {
    return options.fn(this);
  }
  return options.inverse(this);
 ...
 * Block helper that compares the length of the given array to
 * the number passed as the second argument. If the array length
 * is less than the given `length`, the block is returned,
 * otherwise an inverse block may optionally be returned.
 *
 * @name .lengthLt
 * @param {Array} `array`
...
helpers.lengthLt = function(array, length, options) {
  if (array.length < length) {
    return options.fn(this);
  }
  return options.inverse(this);
 ...
 * Block helper that compares the length of the given array to
 * the number passed as the second argument. If the array length
 * is greater than or equal to the given `length`, the block is returned,
 * otherwise an inverse block may optionally be returned.
 *
 * @name .lengthGte
 * @param {Array} `array`
...
helpers.lengthGte = function(array, length, options) {
  if (array.length >= length) {
    return options.fn(this);
  }
  return options.inverse(this);
 ...
 * Block helper that compares the length of the given array to
 * the number passed as the second argument. If the array length
 * is less than or equal to the given `length`, the block is returned,
 * otherwise an inverse block may optionally be returned.
 *
 * @name .lengthLte
 * @param {Array} `array`
...
helpers.lengthLte = function(array, length, options) {
  if (array.length <= length) {
    return options.fn(this);
  }
  return options.inverse(this);
