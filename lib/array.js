...
/**
 * Return all of the items in the two collections specified in
 * a single collection.
 *
 * ```handlebars
 * <!-- foo: ['a', 'b'] -->
 ...
 * @param {Array} `arrayA`
 * @param {Array} `arrayB`
 * @return {Array} Array containing first the elemens of array As then of B
 * @api public
 */

helpers.concat = function(arrayA, arrayB) {
