...
/**
 * Transforms object to `key="value"`, to be used with HTML attributes
 * @author: Marie Hogebrandt <https://github.com/Melindrea>
 * @param  {Object} values
 * @return {Object}
 */
Utils.pairedAttributes = function (values) {
  var pairedValues = Object.keys(values).map(function (key) {
