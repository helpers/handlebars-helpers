...
* **[urlParse](#urlParse)** ([code](lib/url.js#L97) | [tests](test/url.js#L45))
* **[parseQueryString](#parseQueryString)** ([code](lib/url.js#L109) | [tests](test/url.js#L57))
* **[stripQuerystring](#stripQuerystring)** ([code](lib/url.js#L121) | [tests](test/url.js#L24))
* **[stripProtocol](#stripProtocol)** ([code](lib/url.js#L141) | [no tests])
...
### [{{urlParse}}](lib/url.js#L97)

Parses a `url` string into an object.
If parseQueryString options is true it will parse the query string
of given `url`.

**Params**

* `str` **{String}**: URL string
* `options` **{Options}**: Handlebars provided options object
* `returns` **{Object}**: Returns a parsed object

### [{{parseQueryString}}](lib/url.js#L109)

Parses a `queryString` string into an object.
...
### [{{stripQuerystring}}](lib/url.js#L121)
...
_This file was generated by [verb-generate-readme](https://github.com/verbose/verb-generate-readme), v0.6.0, on November 23, 2018._