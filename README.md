...
Currently **190 helpers** in **20 categories**:
...
* **[concat](#concat)** ([code](lib\array.js#L79) | [no tests])
* **[eachIndex](#eachIndex)** ([code](lib\array.js#L103) | [tests](test\array.js#L58))
* **[filter](#filter)** ([code](lib\array.js#L128) | [tests](test\array.js#L91))
* **[first](#first)** ([code](lib\array.js#L168) | [tests](test\array.js#L65))
* **[forEach](#forEach)** ([code](lib\array.js#L210) | [tests](test\array.js#L123))
* **[inArray](#inArray)** ([code](lib\array.js#L250) | [tests](test\array.js#L160))
* **[isArray](#isArray)** ([code](lib\array.js#L270) | [tests](test\array.js#L172))
* **[itemAt](#itemAt)** ([code](lib\array.js#L289) | [tests](test\array.js#L182))
* **[join](#join)** ([code](lib\array.js#L320) | [tests](test\array.js#L225))
* **[equalsLength](#equalsLength)** ([code](lib\array.js#L339) | [no tests])
* **[last](#last)** ([code](lib\array.js#L375) | [tests](test\array.js#L240))
* **[length](#length)** ([code](lib\array.js#L405) | [tests](test\array.js#L254))
* **[lengthEqual](#lengthEqual)** ([code](lib\array.js#L421) | [tests](test\array.js#L254))
* **[map](#map)** ([code](lib\array.js#L440) | [tests](test\array.js#L266))
* **[pluck](#pluck)** ([code](lib\array.js#L471) | [tests](test\array.js#L300))
* **[reverse](#reverse)** ([code](lib\array.js#L499) | [no tests])
* **[some](#some)** ([code](lib\array.js#L530) | [tests](test\array.js#L308))
* **[sort](#sort)** ([code](lib\array.js#L558) | [tests](test\array.js#L333))
* **[sortBy](#sortBy)** ([code](lib\array.js#L583) | [tests](test\array.js#L358))
* **[withAfter](#withAfter)** ([code](lib\array.js#L614) | [tests](test\array.js#L390))
* **[withBefore](#withBefore)** ([code](lib\array.js#L644) | [tests](test\array.js#L397))
* **[withFirst](#withFirst)** ([code](lib\array.js#L674) | [tests](test\array.js#L404))
* **[withGroup](#withGroup)** ([code](lib\array.js#L718) | [tests](test\array.js#L418))
* **[withLast](#withLast)** ([code](lib\array.js#L753) | [tests](test\array.js#L428))
* **[withSort](#withSort)** ([code](lib\array.js#L792) | [tests](test\array.js#L442))
* **[unique](#unique)** ([code](lib\array.js#L842) | [tests](test\array.js#L483))
...
Visit the: [code](lib\number.js) | [unit tests](test\number.js) | [issues](https://github.com/helpers/handlebars-helpers/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen+number+helpers))

* **[bytes](#bytes)** ([code](lib\number.js#L24) | [tests](test\number.js#L10))
* **[addCommas](#addCommas)** ([code](lib\number.js#L61) | [tests](test\number.js#L84))
* **[phoneNumber](#phoneNumber)** ([code](lib\number.js#L74) | [tests](test\number.js#L30))
* **[toAbbr](#toAbbr)** ([code](lib\number.js#L92) | [tests](test\number.js#L91))
* **[toExponential](#toExponential)** ([code](lib\number.js#L130) | [tests](test\number.js#L59))
* **[toFixed](#toFixed)** ([code](lib\number.js#L153) | [tests](test\number.js#L37))
* **[toFloat](#toFloat)** ([code](lib\number.js#L169) | [tests](test\number.js#L77))
* **[toInt](#toInt)** ([code](lib\number.js#L179) | [tests](test\number.js#L70))
* **[toPrecision](#toPrecision)** ([code](lib\number.js#L196) | [tests](test\number.js#L48))
...
### [{{concat}}](lib\array.js#L79)

Return all of the items in the two collections specified in a single collection.

**Params**

* `arrayA` **{Array}**
* `arrayB` **{Array}**
* `returns` **{Array}**: Array containing first the elemens of array As then of B
...
### [{{equalsLength}}](lib\array.js#L339)
...
### [{{lengthEqual}}](lib\array.js#L421)

Alias for [equalsLength](#equalsLength)

### [{{map}}](lib\array.js#L440)
