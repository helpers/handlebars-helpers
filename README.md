...
* **[comparison](#comparison)** (code [comparison](lib/comparison.js))
...
* **[date](#date)** (code [date](lib/date.js))
...
* **[i18n](#i18n)** (code [i18n](lib/i18n.js))

  - i18n

* **[inflection](#inflection)** (code [inflection](lib/inflection.js))

  - inflect
  - ordinalize

* **[logging](#logging)** (code [logging](lib/logging.js))
...
* **[markdown](#markdown)** (code [markdown](lib/markdown.js))

  - markdown
  - md

* **[match](#match)** (code [match](lib/match.js))
...
* **[misc](#misc)** (code [misc](lib/misc.js))
...
* **[number](#number)** (code [number](lib/number.js))
...
### [{{changecase}}](lib/utils/index.js#L113)
...
### [{{random}}](lib/utils/index.js#L139)
...
### [{{isUndefined}}](lib/utils/index.js#L152)
...
### [{{isOptions}}](lib/utils/index.js#L166)
...
### [{{getArgs}}](lib/utils/index.js#L178)
...
### [{{isObject}}](lib/utils/index.js#L209)
...
### [{{isEmpty}}](lib/utils/index.js#L222)
