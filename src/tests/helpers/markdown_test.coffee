...
describe "authors", ->
  ...
  # This verion only works if you have a correctly formatted AUTHORS file in the root of your project
  # describe "{{authors}}", ->
...
describe "changelog", ->
  ...
  # This verion only works if you have a correctly formatted CHANGELOG file in the root of your project
  # describe "{{changelog}}", ->
  #   it "should return a list of authors in markdown format, from the default data source", ->
  #     source = "{{changelog}}"
  #     template = Handlebars.compile(source)
